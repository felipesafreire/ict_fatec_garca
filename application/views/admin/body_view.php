...
<head>
    ...
    <title>ICT - Dashboard Administrador</title>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      ...
                      <ul class="nav nav-list tree">
                            ...
                            <li><a href="<?=base_url('admin/edital');?>"><i class="fa fa-file-pdf-o"></i> Edital</a></li>
                            <li><a href="<?=base_url('admin/requisicao');?>"><span class="icons icon-list"></span> Requisição</a></li>
                      </ul>
                    </li>
